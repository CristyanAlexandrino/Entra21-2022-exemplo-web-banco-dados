...
using Entra21.CSharp.ClinicaVeterinaria.Repositorio.Repositorio;
...
namespace Entra21.CSharp.ClinicaVeterinaria.Servico
{
    public class VeterinarioServico : IVeterinarioServico
    {
        ...
        public IList<Veterinario> ObterTodos(string pesquisa) => _veterinarioRepositorio.ObterTodos(pesquisa);
    }
}
